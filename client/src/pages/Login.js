  ...
  return (
    <div style={{
      ...
      <div style={{
            ...
            {logoUrl ? (
              <img src={logoUrl} alt="Logo"
                style={{ width: 72, height: 72, borderRadius: 14,
                  objectFit: 'contain', background: 'white', padding: 6 }} />
            ) : (
              <div style={{ width: 72, height: 72, borderRadius: 14, margin: '0 auto',
                background: 'linear-gradient(135deg,#e17055,#d63031)',
                display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <i className="ti ti-building-store"
                  style={{ fontSize: 32, color: 'white' }} aria-hidden="true" />
              </div>
            )}
          </div>
        ...
        {error && (
          <div style={{ background: 'rgba(214,48,49,0.2)', border: '1px solid rgba(214,48,49,0.4)', borderRadius: 10, padding: '10px 14px', fontSize: 13, color: '#ff7675', marginBottom: 16 }}>
            {error}
          </div>
        )}
        ...
        <div style={{ marginTop: 16, padding: 12,
          ...
          <strong style={{ color: 'rgba(255,255,255,0.6)' }}>Demo:</strong>{' '}
